...
public class GamePlayer {
    ...
    /*
    mas de un gameplayer para un game
     */
    ...
    /*
    mas de un gameplayer para un player
     */
    @ManyToOne(fetch = FetchType.EAGER)
    ...
    /*
    un gameplayer para varios (5) ships que debe dar el juego
     */
    @OneToMany(mappedBy="gamePlayer", fetch=FetchType.EAGER)
    Set<Ship> ships=new HashSet<>();

    /*
    un gameplayer para variso tiros que va a dar el juego
     */
    @OneToMany(mappedBy="gameplayer", fetch=FetchType.EAGER)
    ...
    //uso de la clase Enum GamePlayerState
